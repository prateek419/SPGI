 I'm sharing code that generates several CSV files as output. I created these files at different stages to verify that the code at each step is working as desired.
